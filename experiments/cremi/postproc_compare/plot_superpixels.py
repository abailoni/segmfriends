...
save_plot(fig, "./sp_plots/", "{}_superpixels.png".format(full_name))
fig, axes = get_figure(1,1,figsize=(8,8))
...
save_plot(fig, "./sp_plots/", "{}_with_mask.png".format(full_name))
