...
keys_to_collect = [
    ...
    #(['postproc_config', 'thresh_segm_size'], 'f', 1),
    (['postproc_config', 'edge_prob'], 'f', 1),
    (['multicut_energy'], 'f', 5),
    (['score', 'cremi-score'], 'f', 5),
    (['score', 'adapted-rand'], 'f', 5),
    (['score', 'vi-merge'], 'f', 5),
    (['score', 'vi-split'], 'f', 5),
    (['score_WS', 'cremi-score'], 'f', 5),
    (['score_WS', 'adapted-rand'], 'f', 5),
    (['score_WS', 'vi-merge'], 'f', 5),
    (['score_WS', 'vi-split'], 'f', 5)
]
